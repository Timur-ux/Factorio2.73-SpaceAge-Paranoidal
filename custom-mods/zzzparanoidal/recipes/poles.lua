...
paralib.bobmods.lib.recipe.set_ingredient(
	"bob-big-electric-pole-2",
	{ type = "item", name = "bob-tinned-copper-cable", amount = 10 }
)
paralib.bobmods.lib.recipe.set_ingredient("bob-big-electric-pole-2", { type = "item", name = "bob-brass-alloy", amount = 10 })
paralib.bobmods.lib.recipe.set_ingredient(
...
paralib.bobmods.lib.recipe.set_ingredient("bob-big-electric-pole-4", { type = "item", name = "bob-nitinol-alloy", amount = 10 })
