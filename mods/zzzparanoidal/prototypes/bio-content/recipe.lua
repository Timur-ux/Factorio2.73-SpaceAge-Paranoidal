...
data:extend({ -- Greenhouse
	...
	}, -- BioFarm
	{
		...
		ingredients = {
			...
			{ type = "item", name = "steel-pipe", amount = 30},
		},
		enabled = false,
		energy_required = 5,
	...
	},
	{
		...
		ingredients = {
			...
			{ type = "item", name = "brass-pipe", amount = 30},
		},
		enabled = false,
		energy_required = 5,
	...
	}, -- BIOREACTOR
	{
		...
		ingredients = { { type = "item", name = "bi-bio-reactor", amount = 2}, { type = "item", name = "aluminium-plate", amount = 20}, { type = "item", name = "electronic-circuit", amount = 5} },
		enabled = false,
		energy_required = 5,
