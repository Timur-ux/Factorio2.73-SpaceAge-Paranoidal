...
angelsmods.functions.OV.global_replace_item("brass-gear-wheel", "bob-brass-alloy")
...
bobmods.lib.recipe.add_ingredient("artillery-turret-prototype", {"angels-concrete-brick", 100})
