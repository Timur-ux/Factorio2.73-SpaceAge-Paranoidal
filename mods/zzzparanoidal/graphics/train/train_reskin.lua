...
if settings.startup["res_loc_1"].value then
	...
	-------------------------------------------------------------------------------------------------
	data.raw.locomotive.locomotive.energy_source.smoke[1] = {
		name = "train-smoke",
		deviation = { 0.3, 0.3 },
		frequency = 300,
		position = { 0, -2.75 },
...
if settings.startup["res_loc_2"].value then
	...
	-------------------------------------------------------------------------------------------------
	data.raw.locomotive["bob-locomotive-2"].energy_source.smoke[1] = {
		name = "train-smoke",
		deviation = { 0.3, 0.3 },
		frequency = 200,
		position = { 0, -2.75 },
...
if settings.startup["res_loc_3"].value then
	...
	-------------------------------------------------------------------------------------------------
	data.raw.locomotive["bob-locomotive-3"].energy_source.smoke[1] = {
		name = "train-smoke",
		deviation = { 0.3, 0.3 },
		frequency = 100,
		position = { 0, 0 },
...
data.raw.locomotive["bet-locomotive"].working_sound.sound =
	{ filename = "__BatteryElectricTrain__/sounds/bet-locomotive.ogg", volume = 0.8 }
data.raw.locomotive["bet-locomotive"].working_sound.deactivate_sound =
	{ filename = "__BatteryElectricTrain__/sounds/bet-locomotive-deactivate.ogg", volume = 0.8 }
-------------------------------------------------------------------------------------------------
